...
Generic Identifiers was already present in GML, and as XML is a subset of SGML\citep{xmlFirstWorkingDraft}, and SGML ascended from GML\footnote{http://www.sgmlsource.com/history/roots.htm}, it is only reasonable to assume that the concept has been inherited rather than reinvented.

...
\chapter{Background}
The problem approached in this thesis, is perhaps best summarized by the quote raised in a paper by \citet{krijnen}. That paper, however, approach the problem from a different angle than this thesis. That paper employ an $n-to-n$ approach, whereas this thesis explore an $m-to-n$ approach. The meaning of these terms will be further explored in this thesis.
...
For many good reasons, different formats exist. Simple things such as taste, cause different languages to express the same things through different syntactical constructs. On more complex notes, languages offer different levels of control, and operate at different levels of abstraction. These concepts will be further explored in this thesis.

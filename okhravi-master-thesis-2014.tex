...
Design intentions are of course merely one way of categorizing languages. While this thesis will not attempt to exhaustively identify all possible categorizations, it will attempt to identify some of the, arguably, more significant ones, in regards to markup.

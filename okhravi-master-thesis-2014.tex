...
\subsection{Deriving markup language requirements}
...
\subsubsection{Generic Identifiers}
...
\subsection{Deriving markup transformation requirements}
...
\subsubsection{Separating intents}
...
\subsubsection{Using configurations to map processing functions}
...
\subsection{Proposing a minimal abstract language}
...
\subsubsection{A DSL for generating markup-oriented PEG}
...
\subsection{Proposing an ideal workflow}
...
\subsubsection{Applying the three-step model}
...
\subsubsection{Splitting processing according to intent}
...
\paragraph{Looping the intent-delimited subprograms}
...
\subsubsection{Re-applying the three-step model to each step}
...
\subsubsection{Relating the proposed metalanguage}
...
\subsubsection{An orchestrator file}
...
\subsubsection{An ideal workflow}

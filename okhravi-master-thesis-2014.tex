...
Using an intermediate, format this massive number of conversions could be decreased to simply $2n$. Thus 10 formats would require 20 conversion strategies. Generally visualized in Figure \ref{fig:n-to-n-conversion-boxes-with-intermediate-format}.

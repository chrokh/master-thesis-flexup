...
Having applied the Flexup Translation (Figure \ref{ex:numbered-headings-translation-fupt}) to the AST (Figure \ref{ex:numbered-headings-flXML-ast-raw}), it is then completely possible to run the XSLT interpretation conversion package (Figure \ref{ex:numbered-headings-xslt-package}). The result of applying the package is a new AST, depicted in Figure \ref{ex:numbered-headings-flXML-ast-numbered}.

...
Dealing with derived text of course becomes technically trivial in procedural (in terms of procedurality described in Section \ref{sec:taxonomy}) languages that exhibit language features such as variables.

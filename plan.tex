...
\paragraph{Generic Identifiers.} The proposed language(s) must support the use of generic syntax and contain no forced syntactical keywords. In the case of multiple languages being suggested, only the language used as input to the transformation program must exhibit this property.

...
\end{figure}
%TODO: I should really, really, really call M L instead.
...
\centering
  ...
  % outline
  %\draw (-2,-2) rectangle (2,2) node [text=black,below,left,yshift=-.3cm] {$V, M$};

  % \draw (-.5,0) circle (1) (0,1)  node [text=black,yshift=-1cm,xshift=-.7cm] {$V$}
  %       ( .5,0) circle (1) (0,1)  node [text=black,yshift=-1cm,xshift=.7cm] {$M$}
  %       (-3,-3) rectangle (3,3) node [text=black  ,yshift=-.3cm] {$$};  
  ...
  \label{fig:mixed-content-venn-xml}
\end{figure}

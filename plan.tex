...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[node distance=.15cm]
    ...
    \node (in)  [io, below of=in, yshift=-1.5cm]     {$In$};
    ...
    \node (C0)  [ds,      above of=P0, yshift=2cm] {$C0$};
  ...
  \caption{Suggested refinement where C0 is an orchestrating configuration file that determine the path through the rest of the model. In other words defining the full transformation.}

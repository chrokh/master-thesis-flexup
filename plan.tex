...
Understand, that in \ref{fig:ideal-only-different-intents}, the previously all-encompassing program $P$, has now been refined into its subparts $P1$ to $P4$. Where table in Figure \ref{tbl:ideal-only-different-intents-legend} explain the mapping of intents of the subprograms.
...
$P4$ & Presentations & Converts the document into a presentation oriented format
\\
\end{tabular}
...
\section{A model of an ideal workflow}
\begin{figure}[h]
  \centering

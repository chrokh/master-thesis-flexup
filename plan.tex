...
The focus of this thesis lies in streamlining the process of manual document authoring in markup languages. Consequently, this thesis does not concern itself with the usage of markup languages for the sake of data transport. Expressed in simpler terms, the focus of this thesis lies in simplifying the life of writers. By reducing the amount of meta characters having to be punched out.

Given that markup languages are prolifically used for both both document authoring as well as data transport, it is naïve to assume that an effort in one, will not allow for any potential change in the other. While the author recognizes this area of potential improvement, it will be ignored to reduce the scope of this thesis. Markup languages will within this thesis, mainly, be treated as a means of authoring documents.
